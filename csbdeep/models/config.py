...
class Config(BaseConfig):
    ...
    def __init__(self, axes='YX', n_channel_in=1, n_channel_out=1, train_steps_per_epoch=30, probabilistic=False, allow_new_parameters=False, **kwargs):
        """See class docstring."""
        ...
        self.train_steps_per_epoch = train_steps_per_epoch  # 400  # 参数steps_per_epoch是通过把训练图像的数量除以批次大小得出的
        self.train_learning_rate   = 0.0001  # 0.0004  #
